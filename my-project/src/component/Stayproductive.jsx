    ...
    <section className='pb-[150px]'>
      <div className="container pb-[150px] grid grid-cols-1 md:grid-cols-2 gap-[30px]   place-items-center">
        ...
        <div>
          ...
          <a
            to="/"
            className="text-maincolor hover:text-[#42b0d1] hover:border-[#42b0d1] transition-all duration-200  border-b-2 border-primary border-solid pb-[5px] flex items-center gap-[15px] w-fit"
          >
            See how Fylo works
            <img
              src={ArrowImg}
